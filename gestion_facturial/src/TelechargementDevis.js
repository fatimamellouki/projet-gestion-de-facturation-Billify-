...
export default function TelechargementDevis() {
  const { id } = useParams();
  ...
  const downloadDevis = (type = 'standard') => {
    const endpoint = type === 'personnalisee'
      ? `http://127.0.0.1:8000/api/devis/${id}/CustomTelecharger`
      : `http://127.0.0.1:8000/api/devis/${id}/telecharger`;
        ...
        <div className="p-6">
          <form className="space-y-6">
            ...
            <div className="flex space-x-4">
              <button
                type="button"
                onClick={() => downloadDevis('standard')}
              ...
              <button
                type="button"
                onClick={() => downloadDevis('personnalisee')}
