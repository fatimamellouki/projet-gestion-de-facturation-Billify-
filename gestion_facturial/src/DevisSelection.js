...
export default function DevisSelection() {
  return (
        ...
        <div className="mt-10 flex flex-col md:flex-row justify-center gap-8">
          ...
          <div className="flex flex-col rounded-lg shadow-lg overflow-hidden bg-white transform transition-all hover:scale-105 hover:shadow-xl">
            <div className="flex-1 p-6 flex flex-col justify-between">
              ...
              <div className="mt-6">
                <Link
                  to="/gestionnaire/devis/standard"
          ...
          <div className="flex flex-col rounded-lg shadow-lg overflow-hidden bg-white transform transition-all hover:scale-105 hover:shadow-xl">
            <div className="flex-1 p-6 flex flex-col justify-between">
              <div className="flex-1">
                ...
                <p className="mt-3 text-base text-gray-500">
                  Saisie manuelle complète des services . Parfait pour les prestations de service ou produits non catalogués.
                </p>
              </div>
              <div className="mt-6">
                <Link
                  to="/gestionnaire/devis/personnalise"
